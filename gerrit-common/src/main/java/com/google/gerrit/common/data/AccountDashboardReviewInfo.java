...
public class AccountDashboardReviewInfo {
  protected AccountInfoCache accounts;
  protected Account.Id owner;
  protected List<ChangeInfo> byOwner;
  protected List<ChangeInfo> forReview;
  protected List<ChangeInfo> haveReviewed;

  protected AccountDashboardReviewInfo() {
  }

  public AccountDashboardReviewInfo(final Account.Id forUser) {
    owner = forUser;
  }
