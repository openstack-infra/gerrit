...
public class ReadyForReview implements Callable<ReviewResult> {

  public interface Factory {
    ReadyForReview create(PatchSet.Id patchSetId, String changeComment);
  }
  ...
  @Inject
  ReadyForReview(final ReadyForReviewSender.Factory readyForReviewSenderFactory,
  ...
  public ReviewResult call() throws EmailException,
    ...
    if (!control.canSetReadyForReview()) {
      result.addError(new ReviewResult.Error(
          ReviewResult.Error.Type.READYFORREVIEW_NOT_PERMITTED));
    } else if (patch == null) {
      ...
      final StringBuilder msgBuf =
          new StringBuilder("Patch Set " + patchSetId.get() + ": Ready For Review");
      ...
      ChangeUtil.updatedChange(
          db, currentUser, updatedChange, cmsg, readyForReviewSenderFactory,
